...
# Save the results
model2_doclevel_ranking_path = "methods\\document_based\\model_two_doclevel_bm25_ranking.dict"
...
model2_doclevel_scoreperdoc_ranking_path = (
    "methods\\document_based\\model_two_doclevel_score_perdoc_bm25_ranking.dict"
)
